...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "PKU Operator" -s /ndn/cn/edu/pku -p /ndn/cn/edu/pku/%C1.Operator/ndnops -r ~nlsr/unsigned_operator.cert > ~nlsr/operator.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-key-gen -n /ndn/cn/edu/pku/%C1.Router/pkuhub > ~nlsr/unsigned_router.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "PKU Router pkuhub" -s /ndn/cn/edu/pku/%C1.Operator/ndnops -p /ndn/cn/edu/pku/%C1.Router/pkuhub -r ~nlsr/unsigned_router.cert > ~nlsr/router.cert'
