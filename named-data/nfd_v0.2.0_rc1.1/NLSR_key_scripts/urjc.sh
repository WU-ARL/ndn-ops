...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "URJC Operator" -s /ndn/es/urjc -p /ndn/es/urjc/%C1.Operator/ndnops -r ~nlsr/unsigned_operator.cert > ~nlsr/operator.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-key-gen -n /ndn/es/urjc/%C1.Router/insula > ~nlsr/unsigned_router.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "URJC Router insula" -s /ndn/es/urjc/%C1.Operator/ndnops -p /ndn/es/urjc/%C1.Router/insula -r ~nlsr/unsigned_router.cert > ~nlsr/router.cert'
