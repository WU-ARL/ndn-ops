...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "MICHIGAN" -s /ndn -p /ndn/edu/umich -r umich_unsigned_site.cert > /home/nlsr/site.cert'
