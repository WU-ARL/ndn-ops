...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "MICHIGAN Operator" -s /ndn/edu/umich -p /ndn/edu/umich/%C1.Operator/ndnops -r ~nlsr/unsigned_operator.cert > ~nlsr/operator.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-key-gen -n /ndn/edu/umich/%C1.Router/ndn0 > ~nlsr/unsigned_router.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "MICHIGAN Router ndn0" -s /ndn/edu/umich/%C1.Operator/ndnops -p /ndn/edu/umich/%C1.Router/ndn0 -r ~nlsr/unsigned_router.cert > ~nlsr/router.cert'
