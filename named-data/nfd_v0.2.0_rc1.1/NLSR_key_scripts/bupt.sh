...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "BUPT" -s /ndn -p /ndn/cn/edu/bupt -r /home/nlsr/bupt_unsigned_site.cert > /home/nlsr/bupt_site.cert'
