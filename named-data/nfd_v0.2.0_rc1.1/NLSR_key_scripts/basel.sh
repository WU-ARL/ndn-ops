...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "BASEL Operator" -s /ndn/ch/basel -p /ndn/ch/basel/%C1.Operator/ndnops -r ~nlsr/unsigned_operator.cert > /etc/ndn/nlsr/keys/operator.cert'
...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "BASEL Router cs-ndn-testbed1" -s /ndn/ch/basel/%C1.Operator/ndnops -p /ndn/ch/basel/%C1.Router/cs-ndn-testbed1 -r ~nlsr/unsigned_router.cert > /etc/ndn/nlsr/keys/router.cert'
