...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "LIP6" -s /ndn -p /ndn/fr/edu/lip6 -r /home/nlsr/lip6_unsigned_site.cert > /home/nlsr/lip6_site.cert'
