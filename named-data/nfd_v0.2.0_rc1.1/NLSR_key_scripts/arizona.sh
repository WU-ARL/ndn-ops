...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "ARIZONA" -s /ndn -p /ndn/edu/arizona -r arizona_unsigned_site.cert > /home/nlsr/site.cert'
