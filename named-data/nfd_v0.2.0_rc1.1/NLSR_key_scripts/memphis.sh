...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "MEMPHIS" -s /ndn -p /ndn/edu/memphis -r /home/nlsr/memphis_unsigned_site.cert > /home/nlsr/memphis_site.cert'
