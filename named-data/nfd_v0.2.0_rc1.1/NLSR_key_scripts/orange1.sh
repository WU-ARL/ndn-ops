...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "ORANGE1" -s /ndn -p /ndn/fr/orange1 -r /home/nlsr/orange1_unsigned_site.cert > /home/nlsr/orange1_site.cert'
