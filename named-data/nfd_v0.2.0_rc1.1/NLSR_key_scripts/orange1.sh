...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "ORANGE1 Operator" -s /ndn/fr/orange1 -p /ndn/fr/orange1/%C1.Operator/ndnops -r ~nlsr/unsigned_operator.cert > ~nlsr/operator.cert'
...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "ORANGE1 Router orange-ndn-1" -s /ndn/fr/orange1/%C1.Operator/ndnops -p /ndn/fr/orange1/%C1.Router/orange-ndn-1 -r ~nlsr/unsigned_router.cert > ~nlsr/router.cert'
