...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "CSU" -s /ndn -p /ndn/edu/colostate -r /home/nlsr/csu_unsigned_site.cert > /home/nlsr/csu_site.cert'
