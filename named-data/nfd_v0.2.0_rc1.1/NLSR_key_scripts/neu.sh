...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "NEU Operator" -s /ndn/edu/neu -p /ndn/edu/neu/%C1.Operator/ndnops -r ~nlsr/unsigned_operator.cert > ~nlsr/operator.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-key-gen -n /ndn/edu/neu/%C1.Router/ndnrtr > ~nlsr/unsigned_router.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "NEU Router ndnrtr" -s /ndn/edu/neu/%C1.Operator/ndnops -p /ndn/edu/neu/%C1.Router/ndnrtr -r ~nlsr/unsigned_router.cert > ~nlsr/router.cert'
