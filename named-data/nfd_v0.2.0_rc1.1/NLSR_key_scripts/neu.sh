...
# sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201407080000 -E 201507080000 -N "NEU" -s /ndn -p /ndn/edu/neu -r /home/nlsr/neu_unsigned_site.cert > /home/nlsr/neu_site.cert'
