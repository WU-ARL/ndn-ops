...
#sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201507080000 -E 201810080000 -N "UCLA Router aleph" -s /ndn/edu/ucla/%C1.Operator/ndnops -p /ndn/edu/ucla/%C1.Router/cs/aleph -r ~nlsr/remap_unsigned_router.cert > ~nlsr/remap_router.cert'
