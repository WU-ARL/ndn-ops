...
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-key-gen -n /ndn/com/verisign/%C1.Router/verisigngw > ~nlsr/unsigned_router.cert'
sudo su - nlsr -c 'export HOME=/var/lib/ndn/nlsr/; ndnsec-cert-gen -S 201410080000 -E 201510080000 -N "VERISIGN Router verisigngw" -s /ndn/com/verisign/%C1.Operator/ndnops -p /ndn/com/verisign/%C1.Router/verisigngw -r ~nlsr/unsigned_router.cert > /etc/ndn/nlsr/keys/router.cert'
