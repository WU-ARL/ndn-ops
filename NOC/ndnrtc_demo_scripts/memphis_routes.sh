...
nfdc register ndn:/ndn/cn/edu/bupt/ndnrtc $ARIZONA
nfdc register ndn:/ndn/cn/edu/pku/ndnrtc $ARIZONA
nfdc register ndn:/ndn/cn/edu/tongji/ndnrtc $ARIZONA
nfdc register ndn:/ndn/edu/arizona/ndnrtc $ARIZONA
nfdc register ndn:/ndn/edu/colostate/ndnrtc $MICHIGAN
#nfdc register ndn:/ndn/edu/memphis/ndnrtc 
nfdc register ndn:/ndn/edu/neu/ndnrtc $NEU
nfdc register ndn:/ndn/edu/uci/ndnrtc $ARIZONA
nfdc register ndn:/ndn/edu/ucla/ndnrtc $ARIZONA
nfdc register ndn:/ndn/edu/ucla/remap/ndnrtc $ARIZONA
...
nfdc register ndn:/ndn/fr/lip6/ndnrtc $ORANGE1
nfdc register ndn:/ndn/fr/orange1/ndnrtc $ORANGE1
nfdc register ndn:/ndn/org/caida/ndnrtc $ARIZONA
